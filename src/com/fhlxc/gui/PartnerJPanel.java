...
public class PartnerJPanel extends JPanel {
    ...
    private void setFriendJPanel() {
        ...
        friendJPanel.add(new PartnerInfoJPanel(student, MainWindow.initialWidth / 3 - 20, MainWindow.initialHeight / 4));
    ...
    private void setTaskJPanel() {
        ...
        add(taskJPanel, BorderLayout.CENTER);
    }
}
